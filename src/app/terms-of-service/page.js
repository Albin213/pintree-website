    ...
    <>
      ...
      <div className="px-[24px]">
        ...
        <div className="text-[16px] sm:text-[24px] text-[#000000] font-aeonik-regular xl:px-[240px]">
          ...
          <p className="pt-8 ">
            These Terms of Use{" "}
            <span className="font-aeonik-bold">(“Terms”)</span> govern your
            access to and use of Pintree and any related websites, apps, tools
            and services (collectively, the “Platform” or “Services”).
          </p>
          <p className="pt-4">
          ...
          <p className="pt-4">
            Pintree is a community-based social platform where users can share
            and discover content such as:
          </p>
          ...
          <ul className="pt-4 list-disc pl-5 ms-4 flex flex-col gap-2">
            ...
            <li>
              {" "}
              You are capable of forming a binding contract under applicable
              law, or you have the consent of a parent or legal guardian (if
          ...
          <p className="pt-4">
            ...
            from your parent or legal guardian to use the Services. We may ask
            for additional verification where required by law.
          </p>
          <p className="pt-8 font-aeonik-medium">
            3. Real Identity and Account Registration
          </p>
          <p className="pt-8 font-aeonik-medium">
            3.1 Real identity requirement
          </p>
          <p className="pt-2">
          ...
          <ul className="pt-4 list-disc pl-5 ms-4 flex flex-col gap-2">
            <li>
              {" "}
              Provide your{" "}
              <span className="font-aeonik-medium">real full name, </span>
              matching your ID or commonly used legal name
            </li>
            <li>
              Provide a{" "}
              <span className="font-aeonik-medium">
          ...
          <p className="pt-4">
            If you suspect unauthorized access, you should immediately change
            your password and follow the in-app help or contact{" "}
          ...
          <ul className="pt-4 list-disc pl-5 ms-4 flex flex-col gap-2">
            <li>
              {" "}
              Impersonate another person, brand, organization, or public
              authority
            </li>
            <li>
              {" "}
          ...
          <ul className="pt-4 list-disc pl-5 ms-4 flex flex-col gap-2">
            ...
            <li>
              {" "}
              Share personal photos, posts, blogs, life events, and polls
            </li>{" "}
          ...
          <ul className="pt-4 list-disc pl-5 ms-4 flex flex-col gap-2">
            ...
            <li>
              ...
              Creators do not currently earn revenue directly from Pintree
              (e.g., no ad revenue sharing or creator fund at this time).
            </li>
          ...
          <p className="pt-4">
            If we introduce any paid features, ad products, or revenue sharing
            in the future, they may be governed by additional or updated terms.
          </p>
          <p className="pt-8 font-aeonik-medium">
          ...
          <ul className="pt-4 list-disc pl-5 ms-4 flex flex-col gap-2">
            ...
            <li>
              Authorized promotional / organizational purposes (for Pro
              Accounts).
            </li>
          </ul>
          <p className="pt-4">
          ...
          <ul className="pt-4 list-disc pl-5 ms-4 flex flex-col gap-2">
            ...
            <li>
              Infringe the rights (including privacy and intellectual property)
              of others
            </li>
            ...
            <li>
              ...
              data from Pintree (except as allowed by applicable law and our
              prior written consent)
            </li>
            <li>
              Interfere with the security or proper working of the Platform
              (e.g., hacking, probing, overloading, attacking servers)
            </li>
          </ul>
          <p className="pt-4">
          ...
          <p className="pt-8 font-aeonik-bold">
            6.1 Types of content we support
          </p>
          ...
          <p className="pt-4">
            You are solely responsible for the content you post. You confirm
            that:
          </p>
          <ul className="pt-4 list-disc pl-5 ms-4 flex flex-col gap-2">
            <li>
              {" "}
              You own the content you share, or you have the necessary rights
            ...
            <li>
              {" "}
              Your content complies with these Terms and our Community
              Guidelines.
            </li>
          </ul>
          <p className="pt-4">
            If someone claims that your content violates their rights, you may
            be legally responsible for that content.
          </p>
          <p className="pt-8 font-aeonik-bold">
          ...
          <p className="pt-4">
            ...
            use, host, store, reproduce, modify, adapt, publish, translate,
            create derivative works from, display and distribute your content in
          ...
          <ul className="pt-4 list-disc pl-5 ms-4 flex flex-col gap-2">
            ...
            <li>
              {" "}
              Some content may be visible only to approved connections or
              specific groups
            </li>
          </ul>
          <p className="pt-4">
          ...
          <p className="pt-4">
            We are not obligated to store or keep your content online forever.
            You are encouraged to keep your own backup copies of important
            content.
          </p>
          ...
          <p className="pt-4">
            ...
            features, and all related intellectual property are owned or
            licensed by MCABEE DIGITAL.
          </p>
          <p className="pt-4">
            Except for the limited license given under these Terms, no rights
            are granted to you. You may not copy, modify, distribute, sell, or
            lease any part of our Services or included software, nor may you
            reverse engineer or attempt to extract the source code, except as
            allowed by law.
          </p>
          ...
          <p className="pt-4">
            ...
            rights. We may disable or terminate accounts that repeatedly
            infringe IP rights.
          </p>
          <p className="pt-4">
            {" "}
          ...
          <p className="pt-8 font-aeonik-bold">
            8.2 Our efforts and limitations
          </p>
          <p className="pt-4">
            We actively work to keep Pintree safe, respectful, and reliable.
            This includes:
          </p>
          <ul className="pt-4 list-disc pl-5 ms-4 flex flex-col gap-2">
          ...
          <p className="pt-4">
            ...
            Opinions and posts shared by users do not represent our views. To
            the maximum extent allowed by law, we are not liable for:
          </p>
          <ul className="pt-4 list-disc pl-5 ms-4 flex flex-col gap-2">
          ...
          <ul className="pt-4 list-disc pl-5 ms-4 flex flex-col gap-2">
            ...
            <li>
              {" "}
              Some information (such as messages sent to others, logs required
              by law, or aggregated data) may be retained for legal, security,
              or operational reasons
            </li>
            <li>
              {" "}
              Certain content may remain visible if it has been reshared,
              quoted, or used in group/community contexts
            </li>
          </ul>
          <p className="pt-4">
          ...
          <p className="pt-4">
            Pintree may contain links to third-party websites, apps, or
            services. These are provided for convenience only.
          </p>
          <p className="pt-4">
          ...
          <p className="pt-4">
            We may change, suspend, or discontinue any part of the Services at
            any time, including features and availability, without prior notice.
          </p>
          <h1 className="pt-8 font-aeonik-bold">12. Limitation of Liability</h1>
          <p className="pt-4">
            To the fullest extent permitted by applicable law, MCABEE DIGITAL
            and its directors, officers, employees, partners, and agents will
            not be liable for:
          </p>
          <ul className="pt-4 list-disc pl-5 ms-4 flex flex-col gap-2">
            <li>
            ...
            <li>
              {" "}
              Any loss of profits, revenue, data, goodwill, or opportunity
            </li>
          ...
          <p className="pt-4">
            ...
            <span className="font-aeonik-bold">12 months</span> prior to the
          ...
          <p className="pt-4">
            ...
            notify you (for example, in-app notices or updated “Last updated”
            date). Your continued use of the Services after changes become
          ...
          <p className="pt-4">
            You agree that the courts located in Chennai, Tamil Nadu, India
            shall have exclusive jurisdiction over all disputes arising out of
          ...
          <p className="pt-4">
            ...
            extent necessary, and the rest of the Terms will remain in full
            force and effect.
          </p>
          <p className="pt-8 font-aeonik-bold">16.3 Entire agreement </p>
          <p className="pt-4">
            These Terms (together with our Privacy Policy and Community
            Guidelines) are the entire agreement between you and us regarding
            your use of Pintree and supersede any prior agreements.
          </p>
