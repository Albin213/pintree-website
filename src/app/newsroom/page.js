  ...
  return (
    <>
      ...
      <div className=" px-[24px] 2xl:px-[140px] 3xl:px-[240px]  max-h-max ">
        ...
        <h1 className="text-[24px] sm:text-[40px] text-[#0C0C0C] pt-[135px] sm:pt-[187px] pb-2">
          Latest
        </h1>
        <div className="flex flex-col 2xl:flex-row 2xl:gap-10">
          ...
          <p className="text-[24px] sm:text-[40px] text-[#0C0C0C] leading-[120%] pb-0.5 2xl:hidden inline-block ">
            Pintree Introduces New Community Features to Strengthen Meaningful
            Connections.
          </p>
          <img src="/news1.svg" alt="" className="2xl:w-[600px] h-[338px]" />
          <div>
            <p className="text-[20px] text-[#000000] pb-3.5 hidden 2xl:inline-block ">
              15 December 2025, Mon
            </p>
            <p className="text-[24px] sm:text-[40px] text-[#0C0C0C] leading-[120%] pb-0.5 hidden 2xl:inline-block ">
              Pintree Introduces New Community Features to Strengthen Meaningful
              Connections.
            </p>
            <p className="text-[16px] sm:text-[20px] text-[#0C0C0C] leading-[140%]">
        ...
        <div>
          ...
          <div className="flex flex-col xl:flex-row   gap-6 pb-28 ">
            <div className="flex flex-col xl:w-[464px] ">
              ...
              <p className="text-[16px] sm:text-[20px] text-[#000000] pb-3.5 pt-[20px]">
                09 December 2025, Tue
              </p>
              <p className="text-[24px] sm:text-[40px] text-[#0C0C0C] leading-[120%] pb-3">
